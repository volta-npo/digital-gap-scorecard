...
# 🌐 Digital Gap Scorecard

### A standardized rubric for ranking how urgently a small business needs digital transformation.
...
**Digital Presence** · **No backend. No login. Client data stays local. Standalone SaaS-ready.**

[Live app](https://volta-npo.github.io/10-digital-gap-scorecard/) · [Report an issue](https://github.com/volta-npo/10-digital-gap-scorecard/issues) · [Volta](https://voltanpo.org)
...
**Digital Gap Scorecard** is a polished, local-first open-source tool from Volta's open-source program. It helps Competition judges, chapter leads, and intake reviewers turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
...
Volta needs a consistent way to evaluate need, feasibility, and impact across cities.

### The niche

Nonprofit prioritization of pro bono digital services.

### North-star metric

`applications prioritized with consistent evidence`
...
flowchart TD
    ...
    Evidence --> Workbench["Digital Gap Scorecard"]
    Workbench --> Score["Presence readiness"]
    Score --> Cert["release certification"]
    Cert --> A1["Ranked applicant CSV"]
    Cert --> A2["Reviewer packet"]
    Cert --> A3["Anonymized sponsor summary"]
...
flowchart LR
    subgraph Modules["First-class modules"]
        M1["Evidence guides"]
        M2["Weighted scoring rubric"]
        M3["Bias check questions"]
        M4["Intake summary export"]
    end
    M1 --> Workbench
    M2 --> Workbench
    M3 --> Workbench
...
sequenceDiagram
    ...
    participant T as Digital Gap Scorecard
...
|---|---|
| **Domain workbench** | A purpose-built scorecard interface for a standardized rubric for ranking how urgently a small business needs digital transformation. |
...
|---:|---|---|
| 1 | **Evidence guides** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 2 | **Weighted scoring rubric** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 3 | **Bias check questions** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 4 | **Intake summary export** | Converts field work into repeatable, reviewable Volta delivery evidence. |
...
This release adds a SaaS-grade operating layer so **Digital Gap Scorecard** can stand alone as more than a checklist. It models:
...
```bash
git clone https://github.com/volta-npo/10-digital-gap-scorecard.git
cd 10-digital-gap-scorecard
npm install
npm test
npm run lint
npm run test:e2e
