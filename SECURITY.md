# Security Policy: Digital Gap Scorecard
...
- For this product's domain, review these gates before handoff: Evidence required for scores, Bias check required, Weights must sum to 100.
