export const v3 = {
  ...
  "capabilities": [
    "Domain-specific workbench: Digital Equity Prioritization Desk",
    "Operational table: Applicant scorecards",
  ...
  "releaseChecklist": [
    ...
    "Need Score reaches production threshold",
    "Feasibility Score is documented with evidence",
    "Impact Potential has no unresolved blocker",
    "Ranked applicant CSV verified",
    "Reviewer packet verified",
    "Anonymized sponsor summary verified"
  ],
  "operations": [
